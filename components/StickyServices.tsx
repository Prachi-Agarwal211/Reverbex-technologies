...
const services = [
  ...
  },
  {
    ...
    description: "Landing pages, lead magnets, automated email & WhatsApp follow-ups — every lead tracked and routed instantly.",
...
export default function StickyServices() {
  ...
  return (
    ...
    >
      ...
      {/* Cards — 2-column editorial grid, no pin */}
