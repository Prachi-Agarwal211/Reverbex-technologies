// @ts-nocheck — vendored component (Aceternity UI)
...
class App {
  ...
  onTouchUp() {
    this.isDown = false;
    this.onCheck();
    this.autoScrollTimer = setTimeout(() => { this.isUserInteracting = false; }, 3000);
  }
  onWheel(e) {
    this.isUserInteracting = true;
    clearTimeout(this.autoScrollTimer);
  ...
  update() {
    if (!this.isUserInteracting && this.autoScrollSpeed > 0) {
