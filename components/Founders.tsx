        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {founders.map((f, i) => (
            <motion.div 
              ...
              key={i} 
              className="p-8 md:p-10 border border-white/5 bg-[#0a0a0a] md:bg-white/[0.02] md:backdrop-blur-md hover:bg-[#111] md:hover:bg-white/[0.05] hover:border-white/20 transition-all duration-500 text-center group rounded-2xl md:rounded-3xl shadow-xl md:hover:-translate-y-2 relative overflow-hidden"
            >
