  ...
  return (
    <div ref={containerRef} className="w-full text-white">
      ...
      <div className="ind-section mb-32 grid grid-cols-2 gap-px bg-[#1A1A1A] border border-[#1A1A1A]">
        {industry.metrics.map((metric, idx) => (
          <div key={idx} className="bg-[#0A0A0A] p-12 text-center flex flex-col justify-center">
            <div className="text-4xl md:text-6xl font-black text-[#EAB308] mb-4" style={{ fontFamily: "var(--font-heading), sans-serif" }}>
              {metric.value}
            </div>
      ...
      <div className="ind-section mb-32">
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-16" style={{ fontFamily: "var(--font-heading), sans-serif" }}>
      ...
      {industry.relatedCaseStudySlug && (
        <div className="ind-section mb-32">
          ...
          >
            ...
            <span className="text-2xl md:text-4xl font-bold text-white block mb-4" style={{ fontFamily: "var(--font-heading), sans-serif" }}>
