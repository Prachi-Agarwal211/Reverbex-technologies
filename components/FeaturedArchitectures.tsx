...
export default function FeaturedArchitectures() {
  ...
  return (
    <section ref={containerRef} id="architectures" className="relative w-full bg-[#050505] overflow-hidden">
      ...
      <div className="pt-24 md:pt-32 pb-16 md:pb-24 max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="cases-header text-center md:text-left">
          <h2 className="text-[clamp(2.5rem,6vw,5.5rem)] text-white mb-4 tracking-tight leading-tight" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>
             ...
             <div key={i} className="case-card flex-shrink-0 w-full md:w-[70vw] lg:w-[60vw] h-[65vh] md:h-[80vh] md:mr-32 relative flex flex-col justify-end p-6 md:p-16 rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] border border-white/5 hw-accelerated">
               ...
               <div className="relative z-30 max-w-4xl">
                 ...
                 <div className="title-mask overflow-hidden mb-6">
                   <h3 className="text-3xl md:text-5xl lg:text-6xl text-white tracking-tight leading-none inline-block pb-1" style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}>
                     {item.title}
                   </h3>
                 </div>
                 ...
                 <div className="flex flex-wrap gap-2 md:gap-3">
                   {item.stack.map((tech, j) => (
                      <span key={j} className="title-mask overflow-hidden inline-block">
                        <span className="px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-white/10 bg-white/5 text-white/80 text-xs md:text-sm tracking-wide font-medium backdrop-blur-md inline-block">
                          {tech}
                        </span>
                      </span>
                   ))}
