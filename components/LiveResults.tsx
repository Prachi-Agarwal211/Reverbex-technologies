...
function CounterItem({
  ...
  return (
    ...
    >
      <span className="text-[#EAB308] text-5xl md:text-6xl font-black mb-3 tracking-tighter tabular-nums">
        {prefix}
        {count.toLocaleString()}
        {suffix}
      </span>
      <h3 className="text-white text-lg font-bold mb-1">{label}</h3>
      <p className="text-[#666666] text-sm font-medium">{subtext}</p>
    </div>
  );
}
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left mb-16 md:mb-20 max-w-2xl">
          <div className="results-eyebrow flex items-center gap-3 mb-4">
        ...
        >
          ...
          <div className="results-card md:col-span-2 md:row-span-2 flex flex-col items-start p-10 md:p-12 bg-[#0A0A0A] border border-[#1A1A1A] rounded-xl hover:border-[#EAB308]/30 transition-all duration-300">
            <span className="text-[#EAB308] text-7xl md:text-8xl font-black mb-3 tracking-[-0.04em]">
              500+
            </span>
